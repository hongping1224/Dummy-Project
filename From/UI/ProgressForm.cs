...
namespace StoneCount.UI
{
    public partial class ProgressForm : Form
    {
        ...
        public void DoAll(string DSMPath, string ImageOutPath)
        {
            ...
            DetrendFileName = "DetrendingDSM.txt";
        ...
        public void GenerateContour()
        {
            ...
            worker.DoWork += new DoWorkEventHandler((ss, eee) =>
            {
                ExtraProgram.GenerateSHPContour(FactorialResultPath, ImageOutPath, null, null);
            });
            worker.RunWorkerCompleted += new RunWorkerCompletedEventHandler((ss, ee) =>
            {
                this.Invoke((MethodInvoker)delegate
        ...
        public void SaveResult()
        {
            ...
            worker.RunWorkerCompleted += new RunWorkerCompletedEventHandler((ss, ee) =>
            {
                this.Invoke((MethodInvoker)delegate
                {
                    ...
                    {
                        zero = new Bitmap(ImageOutPath + ".tif");
                    }
                    else
                    {
                        zero = new Bitmap(Path.ChangeExtension(ImageOutPath, ".tif"));
                    }
